...
const contractABI = require("../artifacts/contracts/Compoundfinance.sol/Compoundfinance.json").abi;

program
    .name("compoundfinance-cli")
    .description("CLI tool for Compoundfinance smart contract")
    .version("1.0.0");
